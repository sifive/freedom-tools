...
{
    CPURISCVState *env = &RISCV_CPU(obj)->env;
    set_misa(env, RVXLEN | RVI | RVM | RVA | RVF | RVD | RVC | RVS | RVU | RVB | RVV | RVZfh);
...
{
    CPURISCVState *env = &RISCV_CPU(obj)->env;
    set_misa(env, RV32 | RVI | RVM | RVA | RVF | RVC | RVU | RVB);
    set_priv_version(env, PRIV_VERSION_1_10_0);
...
static Property riscv_cpu_properties[] = {
    ...
    DEFINE_PROP_UINT16("vlen", RISCVCPU, cfg.vlen, 512),
...
static const TypeInfo riscv_cpu_type_infos[] = {
    ...
    DEFINE_CPU(TYPE_RISCV_CPU_SIFIVE_VIU75,     rvxx_sifive_viu_cpu_init),
#endif
};
